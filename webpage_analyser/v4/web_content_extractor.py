...
def setup_dependencies():
    ...
    try:
        ...
        subprocess.check_call([
            ...
            "trafilatura", "requests", "beautifulsoup4", "lxml",
...
Examples:
  ...
  python web_content_extractor.py -u "https://example.com/article" -q "specific topic" -o output.md
    ...
    # Extract content
    content_dict = extract_main_content(args.url)
    ...
    # Format output
    output = format_output(content_dict, args.query, filter_by_query=not args.no_filter)
